...
*/
/**************************************************************************/
max31856_conversion_mode_t STM32_MAX31856::getConversionMode(void) {
...
*/
/**************************************************************************/
void STM32_MAX31856::setColdJunctionFaultThreshholds(int8_t low,
                                                        int8_t high) {
...
*/
/**************************************************************************/
void STM32_MAX31856::setNoiseFilter(max31856_noise_filter_t noiseFilter) {
...
*/
/**************************************************************************/
void STM32_MAX31856::setTempFaultThreshholds(float flow, float fhigh) {
  int16_t low, high;
...
*/
/**************************************************************************/
float STM32_MAX31856::readCJTemperature(void) {
...
uint16_t STM32_MAX31856::readRegister16(uint8_t addr) {
